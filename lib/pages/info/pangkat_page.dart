  ...
  updateData() async {
    ...
    if (token != null) {
      setState(() {
        ...
        bloc_data.Pangkat(Nip, Riwayat, _current_page);
      });
    } else {
                        ...
                        children: [
                          Card(
                            child: Container(
                                height: 300,
                                width: 100,
                                child: _DataPangkat.isEmpty
                                    ? Center(
                                        child: Text("No Data"),
                                      )
                                    // The ListView that displays photos
                                    : ListView.builder(
                                        itemCount: _DataPangkat.length,
                                        itemBuilder: (BuildContext ctx, index) {
                                          return Card(
                                            child: ListTile(
                                                leading: Text(
                                                    _DataPangkat[index]["no"] +
                                                        "."),
                                                title: Text(_DataPangkat[index]
                                                        ['pangkat'] +
                                                    "  (" +
                                                    _DataPangkat[index]
                                                        ['jenis_kenaikan'] +
                                                    ") " +
                                                    " - " +
                                                    _DataPangkat[index]['tmt']),
                                                subtitle: Text("Nomor SK : " +
                                                    _DataPangkat[index]
                                                        ['nomor_sk']),
                                                trailing:
                              ...
                              for (var i = 1; i <= _total_page; i++)
                                Padding(
                                  ...
                                  child: InkWell(
                                      onTap: () {
                                        (i != _current_page)
                                            ? bloc_data.Pangkat(Nip, Riwayat, i)
                                            : print("Clicked");
                                      },
                                      child: Container(
                                        height: 40,
